...
// Animated counter component — punching machine style
function AnimatedCounter({ value, suffix }) {
    ...
    useEffect(() => {
        if (isInView) {
            // Animate from 0 to target value with ease
            animate(motionValue, value, {
                duration: 2,
                ease: [0.16, 1, 0.3, 1], // expo-out — fast punch then settle
            });
        }
    }, [isInView, motionValue, value]);

    // Round to integer as it animates
